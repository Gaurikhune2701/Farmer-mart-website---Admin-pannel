    ...
    <div class="page-content">
        <div class="page-header">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="padding:10px">
                <h5 class="mb-sm-0 custom-heading">View User</h5>
            ...
            <div class="table-content table-basic">
                <div class="card" style="margin:10px">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5>User Details</h5>
                        <div>
                            <a href="userReport.php" class="btn btn-primary">
                            User Report
                            </a>
                        </div>
                    </div>
                            ...
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    curl_setopt_array($curl, array(
                                        CURLOPT_URL => $base_url . '/Routes/fetch_user.php?id=' . $id,
                                    ...
                                    if (!empty($user)) {
                                        ...
                                        echo "<tr><td>Designation</td><td>{$user['designation']}</td></tr>";
                                        echo "<tr><td>Mobile No.</td><td>{$user['mobileNo']}</td></tr>";
                                        echo "<tr><td>Email</td><td>{$user['email']}</td></tr>";
                                        // echo "<tr><td>Action</td><td><a href='userReport.php' class='btn btn-danger'>Cancel</a></td></tr>";
                                    } else {
