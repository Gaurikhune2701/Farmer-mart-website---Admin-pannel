    ...
    <div class="page-content">
        <div class="page-header">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="padding:10px">
                <h5 class="mb-sm-0 custom-heading">Contact Details</h5>
                                ...
                                <?php
                                    ...
                                    curl_setopt_array($curl, array(
                                      ...
                                      CURLOPT_HTTPHEADER => array(
                                        'Cookie: PHPSESSID=kdrg5daqrf46lu750o9gtk65tk'
                                      ),
                                    ));
                                    ...
                                    if (curl_errno($curl)) {
                                        ...
                                        if ($data['status'] === 'success') {
                                            ...
                                            echo "<tr>
                                                        ...
                                                        <td>{$data['data'][0]['email_id']}</td>
                                                        <td>{$data['data'][0]['address']}</td>
                                                        <td>{$data['data'][0]['contents']}</td>
                                                        <td>{$data['data'][0]['copyrights']}</td>
                                                        <td>
                                                            <a href='view_contactDetailsReport.php?id={$data['data'][0]['id']}' class='btn btn-success mb-1'>View</a>
                                                            <a href='edit_contactDetails.php?id={$data['data'][0]['id']}' class='btn btn-warning'>Update</a>
                                                        </td>
                                                      </tr>";
