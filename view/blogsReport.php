    ...
    <div class="page-content">
        <div class="page-header">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="padding:10px">
                <h5 class="mb-sm-0 custom-heading">Blogs Report</h5>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                        <li class="breadcrumb-item active">Blogs Report</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="table-content table-basic">
                <div class="card" style="margin:10px">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5>Blogs Report</h5>
                        <div>
                            <a href="addBlog.php" class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    curl_setopt_array($curl, array(
                                      CURLOPT_URL => $base_url . '/Routes/fetch_allBlogs.php',
                                        ...
                                        if ($data['status'] === 'success') {
                                            foreach ($data['data'] as $blog) {
                                                ...
                                                echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href='view_singleBlogReport.php?id={$blog['id']}' class='btn btn-success mb-1'>View</a>
                                                            <a href='edit_blog.php?id={$blog['id']}' class='btn btn-warning mb-1'>Update</a>
                                                            <a href='../Controller/check_deleteBlog.php?id={$blog['id']}' class='btn btn-danger' onclick=\"return confirm('Are you sure you want to delete this record?')\">Delete</a>
                                                        </td>
                                                      </tr>";
                                            }
                                        } else {
