    ...
    <div class="page-content">
        <div class="page-header">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="padding:10px">
                <h5 class="mb-sm-0 custom-heading">Ticket Report</h5>
    ...
    <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => $base_url . '/Routes/fetch_allTicket.php',
                ...
                if ($data['status'] === 'success') {
                    foreach ($data['data'] as $ticket) {
                        echo "<tr>
                                ...
                                <td>
                                    <a href='view_singleTicketReport.php?ticket_id={$ticket['ticket_id']}' class='btn btn-success mb-1'>View</a>
                                    <a href='edit_ticket.php?ticket_id={$ticket['ticket_id']}' class='btn btn-warning'>Update</a>
                                </td>
                              </tr>";
                    }
                } else {
...
<script src="../View/assets/js/pages/datatables.init.js"></script>a
</body>
</html>
<!-- <a href='../Controller/check_deleteTicket.php?ticket_id={$ticket['ticket_id']}' class='btn btn-danger' onclick=\"return confirm('Are you sure you want to delete this record?')\">Delete</a> -->
