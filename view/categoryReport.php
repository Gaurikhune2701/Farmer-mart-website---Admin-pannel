    ...
    <div class="page-content">
        <div class="page-header">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="padding:10px">
                <h5 class="mb-sm-0 custom-heading">Category Report</h5>
            ...
            <div class="table-content table-basic">
                <div class="card" style="margin:10px">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="manageCategories.php" class="btn btn-primary">Add New</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    curl_setopt_array($curl, array(
                                      CURLOPT_URL => $base_url . '/Routes/get_allCategory.php',
                                    ...
                                    if (curl_errno($curl)) {
                                        ...
                                        if ($data['status'] === 'success') {
                                            foreach ($data['data'] as $category) {
                                                $rowColor = ($category['status'] === 'Inactive') ? 'style="background-color: #FFB6C1; color: #333333;"' : '';
                                                // $rowColor = ($category['status'] === 'Inactive') ? 'style="background-color: red; color: white;"' : '';
                                                ...
                                                // }
                                                echo "<tr>
                                                        <td $rowColor>{$category['sr.no']}</td>
                                                        <td $rowColor>{$category['category_name']}</td>
                                                        <td $rowColor>{$category['status']}</td>
                                                        <td $rowColor>{$image_html}</td>
                                                        <td $rowColor>{$category['description']}</td>
                                                        <td>
                                                            <a href='view_singleCategoryReport.php?sr_no={$category['sr.no']}' class='btn btn-success'>View</a>
                                                            <a href='edit_category.php?sr_no={$category['sr.no']}' class='btn btn-warning'>Update</a>
                                                            <a href='../Controller/check_deleteCategory.php?sr_no={$category['sr.no']}' class='btn btn-danger' onclick=\"return confirm('Are you sure you want to delete this record?')\">Delete</a>
                                                        </td>
                                                      </tr>";
                                            }
                                        } else {
